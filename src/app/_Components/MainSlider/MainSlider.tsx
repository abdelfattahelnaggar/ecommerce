              ...
              >
                <SwiperSlide>
                  <div className="relative h-full group">
                    ...
                    <div className="absolute bottom-6 left-6 text-white">
                      <h3 className="text-2xl font-bold mb-2">Fresh Groceries</h3>
                      <p className="text-sm opacity-90">Premium quality at unbeatable prices</p>
                    </div>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="relative h-full group">
                    ...
                    <div className="absolute inset-0 bg-black/20"></div>
                    <div className="absolute bottom-6 left-6 text-white">
                      <h3 className="text-2xl font-bold mb-2">Organic Selection</h3>
                      <p className="text-sm opacity-90">Healthy choices for your family</p>
                    </div>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="relative h-full group">
                    ...
                    <div className="absolute bottom-6 left-6 text-white">
                      ...
                      <p className="text-sm opacity-90">Everything you need, delivered fresh</p>
                    </div>
                  </div>
                </SwiperSlide>
              </Swiper>
